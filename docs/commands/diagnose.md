...
`grunnr diagnose` matches a free-form symptom string (typically an error
...
```
# Run from: /tmp/grunnr-fixture
$ grunnr diagnose "user-123" --min-confidence 0.1
...
```
# Run from: /tmp/grunnr-fixture
$ grunnr diagnose "invalid credentials"
