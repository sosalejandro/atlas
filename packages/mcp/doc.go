// Package mcp serves the grunnr index to coding agents over the Model Context
// Protocol, on stdio.
//
...
// revision grunnr speaks to that SDK's release cadence. The protocol is
...
// on a hallucinated call, and the index is the thing every other grunnr answer
